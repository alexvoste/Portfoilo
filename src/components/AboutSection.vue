<template>
  <section id="about" class="section-animate">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20">
      <div class="content-card p-6 sm:p-8 md:p-12">
        <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-6" style="color: #e0e0e0; font-family: 'IBM Plex Sans', 'Inter', sans-serif;">
          /whoami
        </h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 my-8 sm:my-12">
          <div class="grid-card p-4 sm:p-5" style="background: #1e1f1e; border: 1px solid #2a2b2a; border-radius: 0;">
            <h3 class="text-lg sm:text-xl font-semibold mb-2" style="color: #4a6a8a; font-family: 'IBM Plex Sans', 'Inter', sans-serif;">
              OS Dev
            </h3>
            <p class="text-sm sm:text-base" style="color: #a0a0a0; font-family: 'IBM Plex Mono', monospace; line-height: 1.6;">
              GloriaOS — x86_64, Long Mode, pure ASM/C.
            </p>
          </div>
          ...
          <div class="grid-card p-4 sm:p-5" style="background: #1e1f1e; border: 1px solid #2a2b2a; border-radius: 0;">
            ...
            <p class="text-sm sm:text-base" style="color: #a0a0a0; font-family: 'IBM Plex Mono', monospace; line-height: 1.6;">
              throwing patches at The Netwide Assembler
            </p>
          </div>
          ...
          <div class="grid-card p-4 sm:p-5" style="background: #1e1f1e; border: 1px solid #2a2b2a; border-radius: 0;">
            ...
            <p class="text-sm sm:text-base" style="color: #a0a0a0; font-family: 'IBM Plex Mono', monospace; line-height: 1.6;">
              bootloader contributor — someone gotta handle that boot protocol nonsense
            </p>
          </div>
